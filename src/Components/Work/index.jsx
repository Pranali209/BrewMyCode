        ...
        <div key={index} className="flex flex-col py-6 ">
          {
            index === 1 ? <div className='mt-10'>
              <img src={card.image} alt={card.title} className={`ml-60 mb-2 w-[80%] shadow-2xl ${card.count} `} />
              <div className="flex justify-between my-10 ml-60 max-md:mx-3 w-[50%]">
              ...
              <div className='mt-10'>
                <img src={card.image} alt={card.title} className={` mb-2 w-[80%] shadow-2xl ${card.count} `} />
                <div className="flex justify-between my-10 max-md:mx-3 w-[45%]">
